...
<a href="data.php" class="btn btn-primary">Go Back</a>              <!-- /.card-header -->
              <!-- form start -->
              <form method="post" <?php echo "action='updateItem.php?id=".$_GET["id"]."'" ?>  enctype="multipart/form-data">
                <div class="card-body">
                  <?php  
  ...
  $sql = "SELECT id, name,company,year,color,engine_no , chassis_no,sold FROM car where id = '$id_of_car'";
    ...
    while($row = mysqli_fetch_assoc($result)) {
      if ($row["sold"]==1){
        ...
        echo "<div class='form-group'>
                    ...
                    <input type='text' class='form-control' id='carName' placeholder='Enter Car Name' required='' name='carname' value='".$row["name"]."'>
                  </div>
                  <div class='form-group'>
                    <label for='carCompany'>Car Company</label>
                    <input type='text' class='form-control' id='carCompany' placeholder='Enter Car Company' required='' name='company' value='".$row["company"]."'>
                  </div>
                  <div class='form-group'>
                    <label for='carYear'>Car Year</label>
                    <input type='Year' class='form-control' id='carYear' placeholder='Enter Car Year' required='' name='year' value='".$row["year"]."'>
                  </div>
                  <div class='form-group'>
                    <label for='carColor'>Car Color</label>
                    <input type='text' class='form-control' id='carColor' placeholder='Enter Car Color' required='' name='color' value='".$row["color"]."'>
                  </div>
                  <div class='form-group'>
                  ...
                  <div class='form-group'>
                    ...
                    <input type='text' class='form-control' id='chassisNo' placeholder='Enter Car Chassis No' required='' name='chassis' value='".$row["chassis_no"]."'>
                  </div>";
