              ...
              <form method="post" action="addperson.php" >
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="carName" placeholder="Enter Name" required="" name="name">
                  </div>
                  <div class="form-group">
                    <label for="carCompany">Phone</label>
                    <input type="text" class="form-control" id="carCompany" placeholder="Enter Phone no" required="" name="phone">
                  </div>
